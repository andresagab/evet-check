        ...
        <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 sm:p-6">
            ...
            <form action="{{ route('sys.activities.update', $activity) }}" method="POST" autocomplete="off" novalidate>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- event_id --}}
                    <div class="col-span-full" x-data x-init="new TomSelect($refs.select_event, {
                        create: false,
                        sortField: {
                            field: 'text',
                            direction: 'asc'
                        ...
                        <select id="event_id" name="event_id" x-ref="select_event" required>
                    ...
                    {{-- location_id --}}
                    <div class="col-span-full" x-data x-init="new TomSelect($refs.select_location, {
                        create: false,
                        sortField: {
                            field: 'text',
                            direction: 'asc'
                        ...
                        <select id="location_id" name="location_id" x-ref="select_location" required>
