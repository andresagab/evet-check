...
<input
    ...
    $attributes->merge([
        ...
        'class' => "px-2 py-1 $textSize w-full bg-white-200 rounded-md focus:outline-none focus:border focus:border-indigo-700 font-normal text-gray-900 appearance-none transition ease-in-out duration-300",
