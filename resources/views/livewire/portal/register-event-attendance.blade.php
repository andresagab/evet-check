    ...
    <x-modals.modal-dialog wire:model='open' includeFooter="0">
        ...
        <x-slot:title>
            <div class="flex flex-row items-center">
                <h3 class="flex-grow font-bold text-lg uppercase text-purple-800 dark:text-purple-300 select-none">{{ __("Inscribirme en un evento") }}</h3>
                ...
                <div class="flex flex-col items-center space-y-6 w-full">
                    ...
                    <x-cards.card title="Datos personales" :footer="0" color="stone-100">
                        <x-slot:content>
                            ...
                            {{-- instructions --}}
                            <p class="font-normal text-md text-slate-200 mb-4">Selecciona un evento disponible y completa el siguiente formulario de inscripción.</p>

                            {{-- form --}}
                            <x-portal.events.attendances.register-form-card :person="$person"/>
                    ...
                    <div class="w-full inline-flex space-x-2 items-center justify-end mt-5">
                        ...
                        {{-- save button --}}
                        <x-buttons.main-button type="submit">Inscribirme</x-buttons.main-button>
                    </div>
