    ...
    <x-modals.modal-dialog wire:model='open' includeFooter="0">
        ...
        <x-slot:title>
            <div class="flex flex-row items-center">
                <h3 class="flex-grow font-bold text-lg uppercase text-purple-800 dark:text-purple-300 select-none">GESTIONAR PERMISOS DE USUARIO</h3>
            ...
            <form wire:submit.prevent='submit' autocomplete="off" novalidate class="w-full">
                ...
                <div class="flex flex-col items-center space-y-6 w-full">
                    ...
                    <div class="w-full inline-flex space-x-2 items-center justify-end mt-5">
                        ...
                        {{-- save button --}}
                        <x-buttons.main-button wire:click="save" wire:confirm="¿Esta segúro de guardar estos permisos en el usuario '{{ $user->name }}'?" type="button">Guardar</x-buttons.main-button>
                    </div>
